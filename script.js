...
function downloadMedia(type, label) {
    ...
    showToast(`Membuka ${label}...`, "info");

    // Dibuka langsung dari event klik pengguna agar browser tidak menganggapnya
    // sebagai popup otomatis yang tidak diizinkan.
    ...
    if (opened) {
        ...
        setDownloadStatus(0, "Link diblokir browser");
        showToast("Link diblokir browser. Izinkan pop-up untuk TikGrab lalu coba lagi.", "error");
    }
}
